...
class ViewAdapter3(private val requireContext: Context, private var data: ArrayList<ColorToneModel>) :
    RecyclerView.Adapter<ViewAdapter3.ViewHolder>() {
    ...
    fun setData(newData: ArrayList<ColorToneModel>) {
        data = newData
        notifyDataSetChanged()
    }

    fun getCurrentWallpaper(position: Int): ColorToneModel {
